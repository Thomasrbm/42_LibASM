#include <stdio.h>
#include <uchar.h> // Indispensable pour char32_t

// On déclare ta fonction ASM
// On utilise long pour correspondre à r14 (64 bits)
...
int main() {
    ...
    long result = ft_atoi_base_utf32(string, base);
